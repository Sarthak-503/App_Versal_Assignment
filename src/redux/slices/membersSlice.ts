...
const membersSlice = createSlice({
  ...
  initialState,
  reducers: {
    updateMemberStatus: (state, action: PayloadAction<{ memberId: string; status: TeamMember['status'] }>) => {
...
export const { updateMemberStatus, addTask, updateTaskProgress, setMembers } = membersSlice.actions;
